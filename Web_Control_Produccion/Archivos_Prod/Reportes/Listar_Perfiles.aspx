<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listar_Perfiles.aspx.cs" Inherits="ControlDescuentos.Archivos.Reportes.Listar_Perfiles" %>
...
<link rel="stylesheet" type="text/css" href="../../jqueryesy/themes/metro-gray/easyui.css"/>
 ...
 <script type="text/javascript" src="../../jqueryesy/jquery.easyui.min.js"></script>
    ...
    <script src="Listar_Perfiles.js?v0.5"></script>
</head>
<body>
     <div class="bg-neutral-100 w-screen h-screen flex flex-col bg-yellow-50 " align="Center" style="background-color:#FCFDFF;">  
      <div class="flex flex-row self-center px-2 py-2 w-8/12 h-screen ">    
         <div class="flex flex-col space-y-2 items-center overflow-hidden  w-1/2" style="padding:2px;">
          ...
          <div class="flex flex-col space-y-2 items-center overflow-hidden w-1/2" style="padding:2px;">
                <input class="easyui-textbox" style="width:100%" id="txtfreportes" data-options="prompt:'Buscar reporte'"/>
                <div class="text-left" style="width:100%; padding:2px; overflow:auto;" >
                    <ul class="easyui-tree" id="lstreportes" style="width:100%; height:100%;" data-options="animate:true,lines:false"></ul>                        
                </div>
         </div>
     </div>
 </div>
