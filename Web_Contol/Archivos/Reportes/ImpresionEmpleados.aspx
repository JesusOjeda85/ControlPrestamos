<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImpresionEmpleados.aspx.cs" Inherits="ControlDescuentos.Archivos.Reportes.ImpresionEmpleados" %>
...
<link rel="stylesheet" type="text/css" href="../../jqueryesy/themes/metro-gray/easyui.css"/>
 ...
 <script type="text/javascript" src="../../jqueryesy/jquery.easyui.min.js"></script>  
   ...
   <script type="text/javascript" src="../../jqueryEsy/plugins/datagrid-cellediting.js"></script>
    ...
    <script src="ImpresionEmpleados.js?v0.6"></script>
</head>
<body>
