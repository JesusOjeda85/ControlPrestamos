...
<link rel="stylesheet" type="text/css" href="../../jqueryesy/themes/metro-gray/easyui.css"/>
 ...
 <script type="text/javascript" src="../../jqueryesy/jquery.easyui.min.js"></script>
    ...
    <script src="Usuarios.js?v0.4"></script>
</head>
<body>
  <div class="w-screen h-screen" align="Center">
      <div class="easyui-panel mb-3" style="padding:2px; width:100%; background-color:#FCFDFF;">                                                 
        ...
        <div class="easyui-layout " style="padding:2px; top:2px; width:90%; height:90%; overflow:hidden;">    
            ...
            <div data-options="region:'center'" style="width:70%; height:100%; padding:6px;" align="center" class="overflow-auto" > 
                <div class="flex flex-col px-4 sm:px-6 md:px-4 lg:px-4 py-4  w-full max-w-md ">   
                    <div class="flex flex-col mb-3">
                        <label class="text-left text-lg text-blue-900">Usuario</label>                    
                        <input class="easyui-textbox" style="width:100%" id="txtusuario"  data-options="required:true"/>                   
                    </div>
                    <div class="flex flex-col mb-3">
                        <label class="text-left text-lg text-blue-900">Contraseña</label>                    
                    ...
                    <div class="flex flex-col mb-3">
                        <label class="text-left text-lg text-blue-900">Apellido Paterno</label>                    
                        <input class="easyui-textbox" style="width:100%" id="txtappaterno" data-options="prompt:''" />                   
                    </div>
                    <div class="flex flex-col mb-3">
                        <label class="text-left text-lg text-blue-900">Apellido Materno</label>                    
                    ...
                    <div class="flex flex-rol space-x-4 mb-3  justify-left items-center">
                          <label class="text-left text-lg text-blue-900">Administrador:</label>
                          <input id="chkadmin" class="easyui-checkbox" name="Admon" value="0" label=""/>                          
                    </div>                    
                    <div class="flex flex-rol space-x-4 mb-3  justify-left items-center">                          
                          <label class="text-left text-lg text-blue-900">Activo:</label>
