<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Captura_Siniestros.aspx.cs" Inherits="ControlDescuentos.Archivos.Captura.Siniestros.Captura_Siniestros" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
 ...
 <script type="text/javascript" src="../../../jqueryesy/jquery.easyui.min.js"></script>
    ...
    <script src="Captura_Siniestros.js?v0.1"></script>    
</head>
<body>   
          ...
          <div class="flex flex-col self-center px-2 py-2 w-8/12 overflow-auto">   
                  <div class="flex flax-row space-x-2 justify-center items-center mb-4">              
                        <div class="easy-panel flex flex-col mb-1 w-1/2 ">
                            <div class="mb-3 justify-center items-center">
                                <label class="text-left text-lg text-blue-900">Seleccione el Tipo de Emisión</label>      
                            </div>
                            <a href="#" id="chkord" class="easyui-linkbutton" data-options="plain:true,toggle:true,group:'gf',selected:true"></a>
                            <a href="#" id="chkext" class="easyui-linkbutton" data-options="plain:true,toggle:true,group:'gf'"></a>                  
                        </div>
                  </div>
                <hr size="8px" class="bg-blue-800 border-blue-800 mb-4" />
                    <div class="flex flax-row space-x-2">
                       ...
                       <div class="flex flex-col mb-1  w-1/2">
                           <label class="text-left text-lg text-blue-900">Zona de Pago</label>                    
                           <input class="easyui-combobox" style="width:100%; text-align:left"  id="cbozonapago" data-options="required:true"/>                                                                         
                      </div> 
                   </div>
                    <div class="flex flax-row space-x-2">                       
                        <div class="flex flex-col mb-1  w-1/2">
                            <label class="text-left text-lg text-blue-900">Causa de Muerte</label>                    
                            <input class="easyui-combobox" style="width:100%; text-align:left"  id="cbocausamuerte" data-options="required:true"/>                                                                         
                        </div> 
                        <div class="flex flex-col mb-1  w-1/2">
                            <label class="text-left text-lg text-blue-900">Concepto</label>                    
                            <input class="easyui-combobox" style="width:100%; text-align:left"  id="cboconcepto" data-options="required:true"/>                                                                         
                        </div> 
                    </div>
                     <div class="flex flax-row space-x-2">
                        <div class="flex flex-col mb-1 w-1/2 ">
                    ...
                    <div class="flex flax-row space-x-2">
                        <div class="flex flex-col mb-1 w-full ">
                            <label class="text-left text-lg text-blue-900">Beneficiario</label>                    
                            <input class="easyui-textbox uppercase"  style="width:100%; text-align:left"  id="txtbeneficiario"  data-options="required:true"/>                   
                        </div>                         
                    </div>                    
                    <div class="flex flax-row space-x-2">
                        <div class="flex flex-col mb-1 w-1/2 ">
                            <label class="text-left text-lg text-blue-900">Importe Bruto</label>                    
                            <input class="easyui-numberbox" style="width:100%; text-align:right"  id="txtimpbruto"  data-options="required:true,groupSeparator:',',precision:2"/>                   
                        </div>
                        <div class="flex flex-col mb-1 w-1/2 ">
                            <label class="text-left text-lg text-blue-900">Importe Adeudo</label>                    
                            <input class="easyui-numberbox" style="width:100%; text-align:right"  id="txtimpadeudo" precision="2" data-options="required:false,groupSeparator:',',precision:2"/>                   
                        </div>   
                        <div class="flex flex-col mb-1 w-1/2 ">
                            <label class="text-left text-lg text-blue-900">Importe Neto</label>                    
                            <input class="easyui-numberbox" style="width:100%; text-align:right"  id="txtimpneto" precision="2" data-options="disabled:true,groupSeparator:',',precision:2"/>                   
                        </div>   
                    </div>   
                    <div class="flex flax-row space-x-2">
                       <div class="flex flex-col mb-1 w-1/2 ">
         ...
         <table class="easyui-datagrid " id="dgdatos" style="width:100%; height:100%;"> 
            <thead>
                <tr>   
                    ...
                    <th data-options="field:'Beneficiario',width:300,align:'center',halign:'center',hidden:true">Beneficiario</th> 
                    <th data-options="field:'fkTipoPuesto',width:80,align:'center',halign:'center',hidden:true">fkTipoPuesto</th>
                    <th data-options="field:'fkCausaMuerte',width:80,align:'center',halign:'center',hidden:true">fkCausaMuerte</th>
                    <th data-options="field:'fkConceptoSiniestro',width:80,align:'center',halign:'center',hidden:true">fkConceptoSiniestro</th>                    
                    <th data-options="field:'fkTipoPago',width:80,align:'center',halign:'center',hidden:true">fkTipoPago</th>
                    <th data-options="field:'fkZonaPago',width:80,align:'center',halign:'center',hidden:true">fkTipoPago</th>
                    <th data-options="field:'fkBanco',width:80,align:'center',halign:'center',hidden:true">fkBanco</th>                    
                    <th data-options="field:'CuentaBancaria',width:80,align:'center',halign:'center',hidden:true">fkZonaPago</th>
