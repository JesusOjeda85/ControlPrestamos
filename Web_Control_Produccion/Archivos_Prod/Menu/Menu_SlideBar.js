$(document).ready(function () {
    ...
    dmPrestamos.addEventListener("click", function () {
        AgregarTabPadre('Captura', '../Captura/Captura.aspx'); 
    });
    ...
    const btnNumeracion = document.getElementById("dmNumeracion");
    btnNumeracion.addEventListener("click", function () {
        AgregarTabPadre('Numeración De Procesos', '../Numeracion/Numeracion.aspx');
    });

    const dmImpresion = document.getElementById("dmImpresionEmision");
    dmImpresion.addEventListener("click", function () {
        AgregarTabPadre('Impresión de Procesos', '../Numeracion/Impresion_Emision.aspx');
    });

    const dmRenumeracion = document.getElementById("dmRenumeracion");
    dmRenumeracion.addEventListener("click", function () {
        AgregarTabPadre('Renumeración de Cheque', '../Numeracion/Renumeracion_Cheques.aspx');
    });
    ...
    //    AgregarTabPadre('Reportes', '../Reportes/Listar_Perfiles.aspx');
    //});
