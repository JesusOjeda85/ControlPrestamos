...
function LIMPIAR_DATOS() {  
    ...
    $('#txtcausamuerte').textbox('setValue', '');
    $('#txtconceptosiniestro').textbox('setValue', '');
    ...
    if ($(btnobj).linkbutton('options').disabled) { return false; }
        ...
        if (carga == "Si") {            
            $('#dgempleados').datagrid({
                url: "../Buscar_Empleados.aspx?modulo=S&busqueda=" + filtro,
                pagination: false,
                enableFilter: false,
                rownumbers: true,
                singleSelect: true,
                ...
                onClickRow: function () {
                    ...
                    $('#txtcausamuerte').textbox('setValue', row.CausaMuerte);                    
                    $('#txtconceptosiniestro').textbox('setValue', row.ConceptoSiniestro);                    
