<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Renumeracion_Cheques_P.aspx.cs" Inherits="ControlDescuentos.Archivos.Numeracion.Prestamos.Renumeracion_Cheques_P" %>
...
<link rel="stylesheet" type="text/css" href="../../../jqueryesy/themes/metro-gray/easyui.css"/>
 ...
 <script type="text/javascript" src="../../../jqueryesy/jquery.easyui.min.js"></script>  
   ...
   <script type="text/javascript" src="../../../jqueryEsy/plugins/datagrid-cellediting.js"></script>
    ...
    <script src="Renumeracion_Cheques_P.js?v0.4"></script>

      <script src="../../../Scripts/Funsiones.js?v0.2"></script>  
</head>
<body>
        ...
        <table class="easyui-datagrid " id="dgdatos" style="width:100%; height:100%;" > 
            <thead>
                <tr>                        
                    ...
                    <th data-options="field:'ChequeInicial',width:110,align:'right',halign:'center',hidden:false,editor:{type:'numberbox',options:{precision:0}}">Cheque Inicial</th>
                    <th data-options="field:'ChequeFinal',width:110,align:'right',halign:'center',hidden:false,editor:{type:'numberbox',options:{precision:0}}">Cheque Final</th>
                    <th data-options="field:'ChequeActual',width:110,align:'right',halign:'center',hidden:false,editor:{type:'numberbox',options:{precision:0}}">Cheque Actual</th>
                </tr>
            </thead>
        </table> 
    </div>
