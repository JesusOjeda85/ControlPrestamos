<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Captura_Devolucion.aspx.cs" Inherits="ControlDescuentos.Archivos.Devoluciones.Captura_Devolucion" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
 ...
 <script type="text/javascript" src="../../jqueryesy/jquery.easyui.min.js"></script>
    ...
    <script src="Captura_Devolucion.js?v0.4"></script>
</head>
<body>
   <div class="w-screen h-screen flex flex-col " align="Center" style="background-color:#FCFDFF;">              
      ...
      <div class=" w-8/12 flex flex-col self-center px-2 py-2 overflow-hidden">
       ...
       <div class="flex flax-row space-x-2">
        ...
        <div class="flex flex-col mb-1  w-1/2">
          <label class="text-left text-lg text-blue-900">Tipo de Adeudo</label>                    
          <input class="easyui-textbox" style="width:100%; text-align:left"  id="txttipo" data-options="readonly:true"/>                                                                         
       </div>                           
      </div>
      <div class="flex flax-row space-x-2">       
       <div class="flex flex-col mb-1 w-1/2 ">         
       ...
       <div class="flex flex-col mb-1  w-1/2">
           <label class="text-left text-lg text-blue-900">Emisión</label>                    
            <input class="easyui-textbox" style="width:100%; text-align:left"  id="txtEmision" data-options="readonly:true"/>                                                                 
       </div>        
       <div class="flex flex-col mb-1  w-1/2">
          <label class="text-left text-lg text-blue-900">Ultima Quincena</label>                    
          <input class="easyui-textbox" style="width:100%; text-align:left"  id="txtultimaquin" data-options="readonly:true"/>                                                                         
      </div>  
    </div>
     <div class="flex flex-row space-x-2">
         <div class="flex flex-col mb-1 w-1/4 ">         
           <label class="text-left text-lg text-blue-900">Importe a Devolver</label>                    
           <input class="easyui-textbox" style="width:100%; text-align:right"  id="txtadeudo" data-options="readonly:true,required:false,groupSeparator:',',precision:2"/>     
       </div> 
       <div class="flex flex-col mb-1 w-1/4 ">         
         <label class="text-left text-lg text-blue-900">Cheque</label>                    
         <input class="easyui-textbox" style="width:100%; text-align:center"  id="txtcheque" data-options="readonly:false,required:true"/>     
      </div> 
     </div>
   ...
   <div class="easyui-dialog flex flex-col items-center" id="win" title="Creditos" closed="true" style="padding:2px;">
     ...
     <table class="easyui-datagrid " id="dgempleados" style="width:100%; height:100%;"> 
      <thead>
          <tr>   
              ...
              <th data-options="field:'ImporteCredito',width:110,align:'right',halign:'center',hidden:false">Importe</th>  
              <th data-options="field:'ImporteIntereses',width:130,align:'right',halign:'center',hidden:false">Importe Interes</th>  
              <th data-options="field:'ImporteCobrado',width:130,align:'right',halign:'center',hidden:false">Importe Cobrado</th>                
              <th data-options="field:'Tipo',width:150,align:'center',halign:'center',hidden:false">Tipo</th>  
              <th data-options="field:'SaldoFavor',width:100,align:'right',halign:'center',hidden:false">Saldo Favor</th>  
              <th data-options="field:'ChequeRecibo',width:100,align:'right',halign:'center',hidden:false">Cheque</th>                               
              <th data-options="field:'TipoPuesto',width:100,align:'center',halign:'center',hidden:false">Tipo Puesto</th>
              <th data-options="field:'ZonaPago',width:100,align:'center',halign:'center',hidden:false">Zona Pago</th>                
              <th data-options="field:'UltimaQnaCobrada',width:150,align:'center',halign:'center',hidden:false">Ultima Quin. Cobrada</th>                
          </tr>
        </thead>
      </table>   
   </div>
