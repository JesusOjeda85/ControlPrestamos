...
<body>
     <div class="bg-neutral-100 w-screen h-screen flex flex-col bg-yellow-50 " align="Center">   
          <div class="easyui-panel mb-3" style="padding:2px; width:100%">                 
                ...
                <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:false,disabled:false" id="btnEditar">Editar</a>
                <a href="#" class="easyui-linkbutton" data-options="plain:false,iconCls:'icon-ok',disabled:false" id="btnAplicar" >Aplicar</a>                                                                     
           </div>  
     ...
     <div class="easyui-dialog flex flex-col items-center space-y-2" id="WDetalle" title="Detalle del Empleado" closed="true" style="padding:2px;">
     ...
     <div class="easyui-dialog flex flex-col items-center space-y-2" id="WEditar" title="Detalle del Empleado" closed="true" style="padding:2px;">
        <div class="easyui-panel mb-3" style="padding:2px; width:100%">                 
            <a href="#" class="easyui-linkbutton" data-options="plain:false,iconCls:'limpiar',disabled:false" id="btnLDetalle" >Limpiar</a>
            <a href="#" class="easyui-linkbutton" data-options="plain:false,iconCls:'icon-save',disabled:false" id="btnGDetalle" >Guardar</a>
        </div> 
         <div class="flex flex-col self-center px-2 py-2 w-full overflow-auto">
