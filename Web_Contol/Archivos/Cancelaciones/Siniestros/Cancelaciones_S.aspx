<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cancelaciones_S.aspx.cs" Inherits="ControlDescuentos.Archivos.Cancelaciones.Prestamos.Cancelaciones_S" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
 ...
 <script type="text/javascript" src="../../../jqueryesy/jquery.easyui.min.js"></script>
    ...
    <script src="Cancelaciones_S.js?v0.1"></script>
</head>
<body>
   <div class="w-screen h-screen flex flex-col " align="Center" style="background-color:#FCFDFF;">              
      ...
      <div class="flex flax-row space-x-2">
          <div class="flex flex-col mb-1  w-1/2">
            ...
            <input class="easyui-textbox" style="width:100%; text-align:left"  id="txtcausamuerte" data-options="readonly:true"/>               
        </div>                            
        <div class="flex flex-col mb-1  w-1/2">
            <label class="text-left text-lg text-blue-900">Concepto Siniestro</label>                    
            <input class="easyui-textbox" style="width:100%; text-align:left"  id="txtconceptosiniestro" data-options="readonly:true"/>               
        </div>                            
      </div>
      <div class="flex flax-row space-x-2">            
        <div class="flex flex-col mb-1 w-1/2 ">
     ...
     <table class="easyui-datagrid " id="dgempleados" style="width:100%; height:100%;"> 
      <thead>
          <tr>   
              ...
              <th data-options="field:'ConceptoSiniestro',width:250,align:'left',halign:'center',hidden:false">Con. Siniestro</th>  
               <th data-options="field:'CausaMuerte',width:250,align:'left',halign:'center',hidden:false">Causa Muerte</th>               
          </tr>
        </thead>
      </table>   
   </div>
