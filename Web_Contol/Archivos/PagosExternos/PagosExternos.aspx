...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
 ...
 <script type="text/javascript" src="../../jqueryesy/jquery.easyui.min.js"></script>
    ...
    <script src="PagosExternos.js?v0.4"></script>
</head>
<body>
   <div class="w-screen h-screen flex flex-col " align="Center" style="background-color:#FCFDFF;">              
      ...
      <div class="flex flax-row space-x-2">       
         <div class="flex flex-col mb-1 w-1/3 ">         
           ...
           <input class="easyui-textbox" style="width:100%; text-align:right"  id="txtadelanto" data-options="readonly:false,required:true,groupSeparator:',',precision:2"/>     
       </div> 
       <div class="flex flex-col mb-1  w-1/3">
            <label class="text-left text-lg text-blue-900">Fecha Adelanto</label>                               
