<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Impresion_Revision_R.aspx.cs" Inherits="ControlDescuentos.Archivos.Captura.Retiros.Impresion_Revision_R" %>
...
<link rel="stylesheet" type="text/css" href="../../../jqueryesy/themes/metro-gray/easyui.css"/>
 ...
 <script type="text/javascript" src="../../../jqueryesy/jquery.easyui.min.js"></script>  
   ...
   <script type="text/javascript" src="../../../jqueryEsy/plugins/datagrid-cellediting.js"></script>
    ...
    <script src="Impresion_Revision_R.js?v0.6"></script>
</head>
    <body>
   <div class="w-screen h-screen flex flex-col " align="Center" style="background-color:#FCFDFF;">          
       <div id="ddatos" class="w-screen h-screen">
            <div class="easyui-panel mb-3" style="padding:2px; width:100%">    
                ...
                <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-BDoc',disabled:false" id="btnImpresionRevision" >Listado de Captura</a>
            </div>  
        ...
        <table class="easyui-datagrid " id="dgprocesos" style="width:100%; height:94.5%;" > 
          <thead>
            <tr>                        
                ...
                <th data-options="field:'FechaAutorizacion',width:200,align:'center',halign:'center',hidden:false">Fecha Proceso</th>
            </tr>
          </thead>
       </table> 
       </div>
