...
$(document).ready(function () {
    ...
    $('#tproesp').tabs('disableTab', 'Lista de Procesos');   
    ...
    $('#dgcat').datagrid({
        ...
        onLoadSuccess: function (data) {
            ...
            if (data.rows.length > 0) { $('#btnEcata').linkbutton({ disabled: false }); }
    ...
    $('#lstRMenus').tree({
        onClick: function (node) {
            ...
            LISTAR_USUARIOS('#dgusumenu', idrol, 'menu');
            LISTAR_CATALOGOS('#dgcat', idrol);
            LISTAR_CONSULTASHISTORIA('#dgcon', idrol);
            LISTAR_MENU_CREACIONPLAZAS('#dgcreacionpla', idrol);
        }
    });
    ...
    $('#lstRmov').tree({
        onClick: function (node) {
            ...
            LISTAR_USUARIOS('#dgusumov', idrol, 'mov');
        }
    });
    ...
    $('#lstRproesp').tree({
        onClick: function (node) {
            ...
            LISTAR_USUARIOS('#dgusuproesp', idrol, 'pe');
    ...
    $('#lstRRep').tree({
        onClick: function (node) {
            ...
            LISTAR_USUARIOS('#dgusurep', idrol, 'rep');
        }
    });
    ...
    $('#lstRter').tree({
        onClick: function (node) {
            ...
            LISTAR_USUARIOS('#dgusuter', idrol, 'ter');
    ...
    $('#lstRFil').tree({
        onClick: function (node) {
            ...
            LISTAR_USUARIOS('#dgfil', idrol, 'fil');
        }
    });
    ...
    $('#lstRproesp').tree({
        onClick: function (node) {
            ...
            $('#txtpproesp').textbox('setValue', node.text);
            $('#txtpproesp').textbox({ readonly: false });          
            $('#tproesp').tabs('enableTab', 'Lista de Procesos');
            $('#tproesp').tabs('enableTab', 'Lista de Usuarios');
...
function LISTAR_ROLES(tobj, tipo) {
    ...
    $.ajax({
        type: "POST",
        url: '../funciones/Fun_PermisosDeUsuarios.aspx/LISTA_DE_ROLES',
...
function CARGAR_MENUS_TREE(tobj) {
    $.ajax({
        type: "POST",
        url: "../funciones/Fun_PermisosDeUsuarios.aspx/LISTAR_MENU",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        beforeSend: function () {
            $('#loading').show();
...
function LISTAR_FORMATOS(tobjeto) {
    ...
    $.ajax({
        type: "POST",
        url: '../funciones/Fun_PermisosDeUsuarios.aspx/LISTA_DE_REPORTES',
        data: JSON.stringify(parametros),
        dataType: "json",
        async: false,
        cache: false,
...
function LISTAR_TERCEROS(tobj) {
    $.ajax({
        type: "POST",
        url: '../funciones/Fun_PermisosDeUsuarios.aspx/LISTA_DE_TERCEROS',
        dataType: "json",
        async: false,
        cache: false,
        contentType: "application/json; charset=utf-8",
...
/*LISTA DE MOVIMIENTOS POR MODULOS*/
function CARGAR_MOVIMIENTOS_TREE(tobj, tipo) {
    var parametros = {};
    parametros.strtipo = tipo;
    $.ajax({
        type: "POST",
        url: '../funciones/Fun_PermisosDeUsuarios.aspx/LISTAR_MOVIMIENTOS',
        data: JSON.stringify(parametros),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        beforeSend: function () {
...
/*LISTA DE PROCESOS ESPECIALES*/
function CARGAR_PROCESOS_ESPECIALES() {
    $.ajax({
        type: "POST",
        url: '../funciones/Fun_PermisosDeUsuarios.aspx/LISTAR_PROCESOS_ESPECIALES',
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        beforeSend: function () {
            $('#loading').show();
...
function LISTAR_USUARIOS(dgcontrol, fkroll, tipo) {

    var parametros = {};
    parametros.fkroll = fkroll;
    parametros.tipo = tipo;
    $.ajax({
        type: "POST",
        url: '../funciones/Fun_PermisosDeUsuarios.aspx/LISTAR_USUARIOS_ROLES',
        data: JSON.stringify(parametros),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        beforeSend: function () {
...
function LISTAR_CATALOGOS(dgcontrol, fkroll) {
    ...
    $.ajax({
        type: "POST",
        url: '../funciones/Fun_PermisosDeUsuarios.aspx/LISTAR_CATALOGOS',
        data: JSON.stringify(parametros),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        beforeSend: function () {
...
/*LISTAR PERMISOS DE BOTONES DE LAS  CONSULTAS DE HISTORIA*/
function LISTAR_CONSULTASHISTORIA(dgcontrol, fkroll) {
    var parametros = {};
    parametros.fkroll = fkroll;
    parametros.tipo = 'R';
    $.ajax({
        type: "POST",
        url: '../funciones/Fun_PermisosDeUsuarios.aspx/LISTAR_CONSULTASHISTORIA',
        data: JSON.stringify(parametros),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        beforeSend: function () {
...
/*LISTAR PERMISOS DE MENU DE CREACION DE PLAZAS*/
function LISTAR_MENU_CREACIONPLAZAS(dgcontrol, fkroll) {
    var parametros = {};
    parametros.fkroll = fkroll;
    parametros.tipo = 'R';
    $.ajax({
        type: "POST",
        url: '../funciones/Fun_PermisosDeUsuarios.aspx/LISTAR_MENU_CREACIONPLAZAS',
        data: JSON.stringify(parametros),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        beforeSend: function () {
...
/*LISTAR LOS INDICADORES ASIGNADOS AL MOVIMIENTO*/
function LISTAR_INDICADORES_ASIGNADOS(tobj) {
    var parametros = {};
    parametros.strclave = "";
    $.ajax({
        type: "POST",
        url: '../funciones/Fun_PermisosDeUsuarios.aspx/LISTAR_INDICADORES_ASIGNADOS',
        data: JSON.stringify(parametros),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        beforeSend: function () {
...
/*CARGAR LOS MOVIMIENTOS ASIGNADOS*/
function CARGAR_MOVIMIENTOS_ASIGNADOS(tobj, fkroll) {
    var parametros = {};
    parametros.fkroll = fkroll,
        parametros.strclave = "";
    $.ajax({
        type: "POST",
        url: '../funciones/Fun_PermisosDeUsuarios.aspx/LISTAR_MOVIMIENTOS_ASIGNADOS',
        data: JSON.stringify(parametros),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        beforeSend: function () {
...
function CARGAR_MOVIMIENTOS(tobj, chkobj, btnobj, objson, id, tipo) {
    if (objson != null) {
        ...
        if (tipo == 'MC') {
            ...
            CARGAR_MOVIMIENTOS_ASIGNADOS('#lstmovimientos', id);
            LISTAR_INDICADORES_ASIGNADOS('#lstind');
        }
    }
    else
        if (tipo == 'MC') { $('#tt').tabs('enableTab', 'Indicadores por Movimiento'); }
}


/*MARCAR LA LISTA DE LOS PROCESOS ESPECIALES POR ROLES*/
...
/*LISTAR PERMISOS DE MENU POR ROLL*/
function SACAR_PERMISOS_MENUS(tobj, id, tipopermisos) {
    ...
    $.ajax({
        type: "POST",
        url: '../funciones/Fun_PermisosDeUsuarios.aspx/LISTAR_PERMISOS_ROLES',
        data: JSON.stringify(parametros),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        beforeSend: function () {
        ...
        success: function (data) {
            ...
            if (json.length > 0) {$('#btnEmenu').linkbutton({ disabled: false });}
            else { $('#btnEmenu').linkbutton({ disabled: true }); }

            var tri = $(tobj).tree('getRoots');
            if (tri.length == json.length) { document.getElementById('chkmenu').checked = true; }
            else { document.getElementById('chkmenu').checked = false; }
...
/*LISTAR LOS PERMISOS DE MOVIMIENTOS POR ROLL*/
function SACAR_PERMISOS_MOVIMIENTOS(id, tipopermisos) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            CARGAR_MOVIMIENTOS('#lstmp', 'chkmp', '#btnEmp', jsonmov, id,'MP');
            CARGAR_MOVIMIENTOS('#lstmc', 'chkmc', '#btnEmc', jsonmov, id, 'MC');
            CARGAR_MOVIMIENTOS('#lstdp', 'chkdp', '#btnEdp', jsonmov, id, 'DP');
            CARGAR_MOVIMIENTOS('#lstrf', 'chkrf', '#btnErf', jsonmov, id, 'RF');
            CARGAR_MOVIMIENTOS('#lstil', 'chkil', '#btnEil', jsonmov, id, 'IL');
        },
        error: function (err) {
            $('#loading').hide(100);
            $.messager.alert('Error', er.statusText, 'error');
...
/*LISTAR PERMISOS DE TERCEROS POR ROLL*/
...
/*LISTAR PERMISOS DE PROCESOS ESPECIALES POR ROLL*/
...
/*LISTAR LOS PERMISOS DE REPORTES POR ROLL*/
...
/*METODOS DE LOS BOTONES DE LIMPIAR ROLL*/
...
/*METOS DE LOS BOTONES NUEVO ROLL*/
...
/*METODOS DE LOS BOTONES DE ELIMINAR ROLL*/
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.d[0] == "0") {
                    ...
                    if (tipo == 'D') {
                        if (lstobj == 'mp') { CARGAR_MOVIMIENTOS_TREE('#lst' + lstobj, 'MP'); }
                        else
                            if (lstobj == 'mc') { CARGAR_MOVIMIENTOS_TREE('#lst' + lstobj, 'MC'); }
                            else
                                if (lstobj == 'dp') { CARGAR_MOVIMIENTOS_TREE('#lst' + lstobj, 'DP'); }
                                else
                                    if (lstobj == 'rf') { CARGAR_MOVIMIENTOS_TREE('#lst' + lstobj, 'RF'); }
                                    else
                                        if (lstobj == 'il') { CARGAR_MOVIMIENTOS_TREE('#lst' + lstobj, 'IL'); }
                    }
...
/*METODOS DE LOS BOTONES DE GUARDAR ROLL*/
