<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="ControlDescuentos.Archivos.Menu_MultiNivel.Menu" %>
         ...
         <ul class="sidebar-nav" id="Menu">                      
             <li class="sidebar-item"  style="display:none"  id="MPrestamos">
                ...
                <ul id="Prestamos" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar" >
                    <li class="sidebar-item" style="display:none" id="dmCaptura">                       
                    ...
                    <li class="sidebar-item" style="display:none" id="MDevoluciones" >
                        ...
                        <ul id="Ded" class="sidebar-dropdown list-unstyled" data-bs-parent="#sidebarsubmenu" >
                    ...
                    <li class="sidebar-item" style="display:none"  id="dmCancelacion">
                        <a href="#" class="sidebar-link" >Cancelaciones</a>
                    </li>
                    <li class="sidebar-item" style="display:none" id="dmAbonos">
                    ...
                    <li class="sidebar-item" style="display:none" id="MImportacion">
                        <a href="#" class="sidebar-link" >
                            ...
                            <span>Actualizacón de Saldos</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item" style="display:none" id="MPadrones">
                        <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse"
                            data-bs-target="#auth" aria-expanded="false" >
                        ...
                        <ul id="auth" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar" >
                            ...
                            <li class="sidebar-item"  id="dmPadronEmp">
                                <a href="#" class="sidebar-link" >Plantilla de Empleados</a>
                            </li>
                        </ul>
                    </li>      
                </ul>
