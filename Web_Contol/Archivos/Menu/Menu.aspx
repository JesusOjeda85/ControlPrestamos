...
<body>    
     <div class="w-screen h-screen flex flex-col" style="overflow:hidden; background-color:#FCFDFF;">
         ...
         <div class="easyui-panel" style="width:100%;">            
             ...
             <a href="#" class="easyui-linkbutton" data-options="plain:true,size:'large',iconAlign:'top',iconCls:'Num32'" style="width:90px;"  id="btnNumeracion">Numeración</a>              
             ...
             <a href="#" class="easyui-linkbutton" data-options="plain:true,size:'large',iconAlign:'top',iconCls:'Con32'" style="width:90px;"  id="btnConsulta">Consulta</a>    
        ...
        <%--  <div id="mreportes" style="width:170px;">
         ...
         <div id="dtap" class="w-full item-center" style="overflow:hidden; position:absolute">
