<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listar_Conceptos.aspx.cs" Inherits="ControlDescuentos.Archivos.AplicarDescuentos.Listar_Conceptos" %>
...
<link rel="stylesheet" type="text/css" href="../../jqueryesy/themes/metro-gray/easyui.css"/>
 ...
 <script type="text/javascript" src="../../jqueryesy/jquery.easyui.min.js"></script>
    ...
    <script src="Listar_Conceptos.js?0.0"></script>
</head>
<body >
    <div class="bg-neutral-100 w-screen h-screen flex flex-col " align="Center" style="background-color:#FCFDFF;">
