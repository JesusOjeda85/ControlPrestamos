...
<body>
            ...
            <li class="sidebar-item" style="display:none" id="btnCaptura">
                ...
                <ul id="Cap" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar" >
                    <li class="sidebar-item"  id="dmPrestamos">
                        <a href="#" class="sidebar-link" >Prestamos</a>
                    </li>
           ...
           <li class="sidebar-item" style="display:none" id="btnPagosExternos">
             ...
             <li class="sidebar-item" style="display:none" id="btnAplicacion">
                 <a href="#" class="sidebar-link" >
                     ...
                     <span>Autorización de Créditos</span>
                 </a>
             </li>
             <li class="sidebar-item" style="display:none" id="btnProduccion">
                 <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse"
                    data-bs-target="#Prod" aria-expanded="false" aria-controls="Produccion">
                    <i class="lni lni-folder"></i>
                    <span>Producción</span>
                 </a>
                 <ul id="Prod" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar" >
                    <li class="sidebar-item"  id="dmNumeracion">
                        <a href="#" class="sidebar-link" >Numeración</a>
                    </li>
                    <li class="sidebar-item"  id="dmImpresionEmision">
                        <a href="#" class="sidebar-link" >Impresión</a>
                    </li>
                    <li class="sidebar-item"  id="dmRenumeracion">
   ...
   <script src="Menu_SlideBar.js?v0.6"></script>
</body>
</html>
