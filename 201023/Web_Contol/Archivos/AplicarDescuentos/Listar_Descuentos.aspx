<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listar_Descuentos.aspx.cs" Inherits="ControlDescuentos.Archivos.AplicarDescuentos.Listar_Descuentos" %>
...
<%
    ...
    if (objusuario != null)
    {
        ...
        string respuesta = ClsObjetos.Llamar_Api.PostItem("CargayDescarga/Cargar_Descuentos", jsonobj);
